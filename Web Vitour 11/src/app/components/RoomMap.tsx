          ...
          <div className="relative rounded-xl overflow-hidden border border-[#c2c6d5] shadow-lg bg-[#f0f3ff]">
            ...
            {pins.map(pin => {
              ...
              return (
                ...
                >
                  <span
                    className={`flex items-center justify-center w-7 h-7 md:w-9 md:h-9 rounded-full text-white shadow-md ring-2 ring-white transition-transform group-hover:scale-110 ${
